...
export default function Recherche() {
  ...
  let heightAdded = Themes.length * 250 + Laboratoires.length*40 + Equipes.length*40;
  ...
  if(myRef2.current) {
    myRef2.current.style.height = minHeightLabo + Laboratoires.length*40 + "px"
  }
        ...
        <div id="tableauLabos" className="flex justify-center mt-5">
          <TableContainer style={{ width: "1200px" }} component={Paper}>
            <Table sx={{ minWidth: 300 }} aria-label="simple table">
              <TableHead>
                <TableRow style={{ backgroundColor: "#F6F5F2", color: "white" }}>
                  <TableCell>
