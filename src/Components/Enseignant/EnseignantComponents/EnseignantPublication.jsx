    ...
    return (
      <div className="">
        ...
        <div className="ml-14 mb-7 mt-7 rounded-lg bg-white">
            <h2 className="text-white font-bold pl-8 py-4 text-xl" style={{backgroundColor:'#25476A'}}>Publier une publication</h2>
            <form className="pb-7">
              <div className="px-12 py-6">
                  ...
                  <div className="mb-4">
                      <label className="block mb-1 font-semibold" style={{fontSize:'21px', color: '#25476A'}}>Contenu</label>
                      <textarea cols="105" rows="10" id="contenu" className="px-4 py-1 bg-transparent border-2 border-gray-500 rounded-sm hover:border-2 hover:border-sky-400" ref={contenu} onChange={handlChange}></textarea>
                  ...
                  <div >
                      ...
                      <input type="file" id="image" className="px-4 py-1" ref={image} onChange={(event) => {
    handlChange(event); 
